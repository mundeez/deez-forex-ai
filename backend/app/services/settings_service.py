...
DEFAULTS = {
    ...
    "team_meta_enabled": "true",
    "team_meta_threshold": "0.50",
...
async def build_settings_response(db: AsyncSession) -> dict:
    ...
    return {
        ...
        "max_weekly_loss_pct": float(all_db.get("max_weekly_loss_pct", "6.0")),
        "max_consecutive_losses": int(all_db.get("max_consecutive_losses", "5")),
        ...
        "exit_rules_enabled": all_db.get("exit_rules_enabled", "true").lower() == "true",
        "profit_lock_enabled": all_db.get("profit_lock_enabled", "true").lower() == "true",
        "profit_lock_giveback_pct": float(all_db.get("profit_lock_giveback_pct", "50.0")),
        "pre_news_exit_enabled": all_db.get("pre_news_exit_enabled", "true").lower() == "true",
        "technical_flip_enabled": all_db.get("technical_flip_enabled", "true").lower() == "true",
        "staleness_enabled": all_db.get("staleness_enabled", "true").lower() == "true",
        "staleness_max_min": float(all_db.get("staleness_max_min", "120.0")),
        "sl_ladder_enabled": all_db.get("sl_ladder_enabled", "true").lower() == "true",
